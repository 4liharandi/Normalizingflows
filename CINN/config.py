...
# Loading/saving: #
###################
folder = f'./output/cinn_AIO_{problem}_{problem_par}_ds_{dataset}_lr_{lr}_snr_{snr}'
...
data_folder = './data'
train_data_targets = os.path.join(data_folder, f'train_{dataset}_{problem}_{problem_par}_snr_{snr}_targets.pt')
train_data_samples = os.path.join(data_folder, f'train_{dataset}_{problem}_{problem_par}_snr_{snr}_samples.pt')
test_data_targets = os.path.join(data_folder, f'test_{dataset}_{problem}_{problem_par}_snr_{snr}_targets.pt')
test_data_samples = os.path.join(data_folder, f'test_{dataset}_{problem}_{problem_par}_snr_{snr}_samples.pt')
datafiles = {
